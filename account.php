...
?> </div>
        ...
        <div class="row footer">
            <div class="col-md-4 box"> <img src="image/admin.svg" width="160"> <a href="#" data-toggle="modal" data-target="#login">Admin Login</a></div>
            <div class="col-md-4 box"> <img src="image/team.svg" width="160"> <a href="#" data-toggle="modal" data-target="#developers">Developers</a> </div>
            <div class="col-md-4 box"> <img src="image/feedback.svg" width="140"> <a href="feedback.php" target="_blank">Feedback</a></div>
        </div>
                ...
                <div class="modal-content text-center">
                    ...
                    <div class="modal-body">
                        <div class="row col-centered">
                            <div class="col-md-5"> <img src="image/Balinag.jpg" width=100 height=100 alt="John Rey Balinag" class="img-rounded">
                                <p>John Rey Balinag</p>
                            </div>
                            <div class="col-md-5"> <img src="image/jorquia.jpg" width=100 height=100 alt="Jan-mae Jorquia" class="img-rounded">
                                <p>Jan-mae Jorquia</p>
                            </div>
                            <div class="col-md-5"> <img src="image/cacho.PNG" width=100 height=100 alt="YZ Cacho" class="img-rounded">
                                <p>YZ Cacho</p>
                            </div>
                            <div class="col-md-5"> <img src="image/tungcul.jpg" width=100 height=100 alt="Camille Tungcul" class="img-rounded">
                                <p>Camille Tungcul</p>
                            </div>
                            <div class="col-md-5"> <img src="image/rubrico.png" width=100 height=100 alt="Abigail Rubrico" class="img-rounded">
                                <p>Abigail Rubrico</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form role="form" method="post" action="admin.php?q=index.php">
                                    <div class="form-group">
                                        <input type="text" name="uname" maxlength="20" placeholder="Admin user id" class="form-control" /> </div>
                                    <div class="form-group">
